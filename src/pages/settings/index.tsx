...
function Settings() {
    ...
    const { dataList, page, pageSize, total, loading, formData, 
        setDataList, setPage, setPageSize, setTotal, setLoading, 
        setFormData, loadData, onChange, handleChange, } = useDataList<SearchType, DataType>({ accountName: "" }, getAccountList)
            ...
            <Col span={8} >
                ...
                <Card className="mt">
                    <Popconfirm
                        ...
                        onConfirm={handle}
                    >
                        <AuthButton type="primary">提交修改</AuthButton>
                    </Popconfirm> 
                </Card>
            </Col>
